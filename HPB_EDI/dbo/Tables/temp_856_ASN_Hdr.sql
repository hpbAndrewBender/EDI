CREATE TABLE [dbo].[temp_856_ASN_Hdr] (
    ...
    [InsertDateTime]    DATETIME      CONSTRAINT [DF_856_ASN_Hdr_temp_InsertDateTime] DEFAULT (getdate()) NOT NULL,
    [Processed]         BIT           CONSTRAINT [DF_856_ASN_Hdr_temp_Processed] DEFAULT ((0)) NOT NULL,
    [ProcessedDateTime] DATETIME      NULL,
    [ASNACKSent]        BIT           CONSTRAINT [DF_856_ASN_Hdr_temp_ASNACKSent] DEFAULT ((0)) NULL,
    [ASNAckNo]          NVARCHAR (10) NULL,
    [GSNo]              NVARCHAR (10) NULL,
    CONSTRAINT [PK_856_ASN_Hdr_temp] PRIMARY KEY CLUSTERED ([ShipID] ASC)
);
