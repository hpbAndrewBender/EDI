CREATE TABLE [EDI].[PurchaseOrderDetail] (
    ...
    CONSTRAINT [FK_PurchaseOrderDetail~PurchaseOrderHeader] FOREIGN KEY ([OrderId]) REFERENCES [EDI].[PurchaseOrderHeader] ([OrderId])
);
...
CREATE NONCLUSTERED INDEX [IX_PurchaseOrderDetail_ItemIdentifier]
    ON [EDI].[PurchaseOrderDetail]([ItemIdentifier] ASC);
