CREATE TABLE [EDI].[InvoiceDetail] (
    ...
    CONSTRAINT [FK_InvoiceDetail~InvoiceHeader] FOREIGN KEY ([InvoiceId]) REFERENCES [EDI].[InvoiceHeader] ([InvoiceId])
);
...
CREATE NONCLUSTERED INDEX [IX_InvoiceDetail_ItemIdentifier]
    ON [EDI].[InvoiceDetail]([ItemIdentifier] ASC);
